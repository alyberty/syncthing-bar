//
//  FinderSync.swift
//  syncthing-bar-finder-extension
//
//  Created by Albert Stark on 16.08.15.
...
class FinderSync: FIFinderSync {
    ...
    var myFolderURL: NSURL = NSURL.fileURLWithPath("/Users/Albert/Sync")!
    ...
    override var toolbarItemName: String! {
        return "syncthing-bar-finder-extension"
    }

    override var toolbarItemToolTip: String! {
        return "syncthing-bar-finder-extension: Click the toolbar item for a menu."
    }
